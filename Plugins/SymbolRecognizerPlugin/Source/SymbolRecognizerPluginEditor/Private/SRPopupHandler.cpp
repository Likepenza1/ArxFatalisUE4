...
public:
	...
	void DoSetupParams()
	{
		...
		Status->SetText(FText::FromString(FString::Printf(TEXT("Symbols: %i | Images Per Symbol: %i"), TookKit->GetCurrentProfileRef().SymbolsAmount, TookKit->GetCurrentProfileRef().ImagesPerSymbol)));
